...
for case in "${char_cases[@]}"; do
    echo "Test char $test_num: ./serializer $case"
    ./Serializer.out $case
    echo
    ((test_num++))
done
...
for case in "${int_cases[@]}"; do
    echo "Test int $test_num: ./serializer $case"
    ./Serializer.out $case
    echo
    ((test_num++))
done
...
for case in "${float_cases[@]}"; do
    echo "Test float $test_num: ./serializer $case"
    ./Serializer.out $case
    echo
    ((test_num++))
done
...
for case in "${double_cases[@]}"; do
    echo "Test double $test_num: ./serializer $case"
    ./Serializer.out $case
    echo
    ((test_num++))
done
